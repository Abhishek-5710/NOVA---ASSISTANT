...
def input_manage(input_text):
        ...
        if output != "No valid time found in input":
            save_to_file(output, time, r'C:\Users\ABHISHEK\OneDrive\Desktop\nova\schedule.txt')
...
def input_manage_Alarm(input_text):
        ...
        if time != "No valid time found in input":
            save_to_Alarm_file(time, r'C:\Users\ABHISHEK\OneDrive\Desktop\nova\Alarm_data.txt')
            print("Schedule_Data_Saved")
        else:
            print("pass")

# input_manage_Alarm("tell me to sleep at 10:30PM")